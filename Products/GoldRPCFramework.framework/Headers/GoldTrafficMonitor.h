//
//  GoldTrafficMonitor.h
//  GTTest
//
//  Created by AlexZhang on 2018/7/9.
...
typedef NS_ENUM(NSInteger, GoldTrafficMonitorNetStatues) {
    GoldTrafficMonitorNetStatuesNotReachable = 0,
    GoldTrafficMonitorNetStatuesReachableViaWiFi,
    GoldTrafficMonitorNetStatuesReachableViaWWAN
};

@interface GoldTrafficMonitor : NSObject
{
    SCNetworkReachabilityRef _reachability;
    SCNetworkReachabilityContext _context;
    GoldTrafficMonitorNetStatues _networkStatus;
...
@property (nonatomic) GoldTrafficMonitorNetStatues netStatus;
...
- (void)updateNetData;
- (void)resetData;
- (GoldTrafficMonitorNetStatues)currentNetStatus;
